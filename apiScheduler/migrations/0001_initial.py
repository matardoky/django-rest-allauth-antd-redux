# Generated by Django 3.1.1 on 2020-10-19 07:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deps', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apiScheduler.deps')),
                ('name2', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apiScheduler.etablissement')),
                ('region', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apiScheduler.region')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('ville', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apiScheduler.ville')),
            ],
        ),
        migrations.CreateModel(
            name='Horaire',
            fields=[
                ...
                ('plage_horaire', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='plagesHoraire', to='apiScheduler.plagehoraire')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
