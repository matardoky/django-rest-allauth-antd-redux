...
import { Form, Tooltip, Input, Col, Row, Checkbox, Switch, Button, Select, InputNumber, Radio, DatePicker } from 'antd';
...
var QuestionIcon = (function () {
  return React.createElement(
    ...
    React.createElement("path", { d: "M512 64C264.6 64 64 264.6 64 512s200.6 448 448 448 448-200.6 448-448S759.4 64 512 64z m0 820c-205.4 0-372-166.6-372-372s166.6-372 372-372 372 166.6 372 372-166.6 372-372 372z" }),
    ...
    React.createElement("path", { d: "M512 732m-40 0a40 40 0 1 0 80 0 40 40 0 1 0-80 0Z" })
  );
});
...
function FormBuilderField(props) {
  ...
  var label = field.tooltip ? React.createElement(
    'span',
    null,
    field.label,
    React.createElement(
  ...
  if (isFieldViewMode) {
    ...
    if (field.renderView) {
      ...
      viewEle = React.createElement(ViewWidget, _extends({ value: viewValue, form: form, field: field }, field.viewWidgetProps));
    } else if (field.link) {
      var href = typeof field.link === 'string' ? field.link : viewValue;
      viewEle = React.createElement(
        'a',
  ...
  return field.noFormItem || field.noStyle ? ele2 : React.createElement(
    FormItem,
    formItemProps,
    ele2
  );
...
function FormBuilder(props) {
  ...
  return React.createElement(FormBuilderInner, _extends({}, props, { form: form ? form.current || form : null, meta: meta }));
  // return (
